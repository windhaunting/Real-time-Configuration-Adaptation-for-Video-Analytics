...
# considering pareo boundary with bounded accuracy
# delete ground truth for profiling why? too costly
...
def simBoundedAcc(data_pose_keypoint_dir, data_pickle_dir, segmentTime, profile_interval_time, minAccuracy, pareto_bound_flag=False):
    ...
    baseline_gt_time = sum(spf_frame_arr[0, :])
    
    print ("acc_frame_arr: ", data_pose_keypoint_dir, data_pickle_dir, acc_frame_arr.shape, spf_frame_arr.shape)
    
    
    print ("baseline_gt_time 3927 sec,  65.25 minutes: ", baseline_gt_time)
    ...
    #print ("accumu_lag_seg_arr: ", minAccuracy, accumu_lag_seg_arr, lst_idx_selected_config)
...
def executeDifferentBoundedAccPTR(data_pose_keypoint_dir, data_pickle_dir, pareto_bound_flag):
    ...
    for minAccuracy in min_acc_lst[2:3]:  
        ...
        if pareto_bound_flag == 0:
            ...
            outDir2 = outDir + "top_k_simulate_result_video05_boundedAccuracy_paretoBound_and_boundedAccuracy_profilingTime_segmentTime_minAcc" + str(minAccuracy) + "/"
        ...
        for segmentTime in lst_segment_time[5:6]:  # lst_segment_time:    # lst_segment_time[2:5]
            ...
            if segmentTime == 6:
                    ...
                    print ("lst_each_seg_time_lag: ", lst_each_seg_time_lag)
...
def execute_different_bound_acc_overTime(data_pose_keypoint_dir, data_pickle_dir, pareto_bound_flag):
    ...
    for minAccuracy in min_acc_lst[1:2]:  
        ...
        legend_labels = []
        for segmentTime in lst_segment_time:          # lst_segment_time
            
            x_lst_stickers_seg_ratio = []

            legend_labels.append('seg time: ' + str(segmentTime) + 's')
            for ratio in lst_profile_interval_time_ratio:
            ...
            lst_x_lst_stickers_seg_ratio.append(x_lst_stickers_seg_ratio)
                ...
                #out_seg_config_selected_file = outDir + "min_acc-" + str(minAccuracy) + "_selected_config"
                #df_config_selected.to_csv(out_seg_config_selected_file, sep='\t', index=False)
        print ("plot_profiling_overtime_delay: ", actual_seg_acc_arr)
