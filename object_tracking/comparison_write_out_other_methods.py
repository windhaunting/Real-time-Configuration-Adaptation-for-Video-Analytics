...
def read_write_operation():
    ...
    dataDir_MoTrack =  "../input_output/object_tracking/sample_video_out/sample_video_json_01/data_instance_xy/minAcc_0.92/video_applied_detection_result/"
    
    
    input_file_path = dataDir_MoTrack + "MOTrack_arr_acc_segment_.pkl"
    ...
    # read delay
    input_file_path = dataDir_MoTrack + "MOTrack_arr_spf_segment_.pkl"
    out_file_path = dataDir_MoTrack + "MOTrack_Segment_spf_traffic.tsv"
    read_acc_pickle_and_write_file(input_file_path, out_file_path)
