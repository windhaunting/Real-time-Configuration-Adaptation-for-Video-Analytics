...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep  6 20:09:33 2019
...
def simBoundedAcc(data_frame_dir, data_pickle_dir, segmentTime, profile_interval_Time, minAccuracy):
    ...
    for seg in range(0, segmentNo):        # test 100 first
        ...
        total_time_profiling = np.sum(seg_spf_arr)  # np.sum(sub_spf_arr)   # np.sum(seg_spf_arr)
        ...
        #print ("process_total_extra_seg_time: ", process_total_extra_seg_time)
        ...
        #print ("frame_id: ", end_finished_frm_id, end_streaming_frm_id, process_total_extra_seg_time)
...
def executeDifferentBoundedAcc(data_frame_dir, data_pickle_dir):
    ...
    outDir = data_pickle_dir + 'simulate_result_06_boundedAccuracy_segmentTime_' + str(segmentTime) + 's/'
    ...
    #xList = min_acc_lst
    #yList = []
    for minAccuracy in min_acc_lst:         # 
        ...
        outDir2 = data_pickle_dir + 'simulate_result_06_boundedAccuracy_segmentTime_' + str(segmentTime) + 's/' + 'minAcc_' + str(minAccuracy) + '/'
