...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep 16 16:18:10 2019
...
def parse_pose_result(pose_result_str, img_path, img_w, img_h, gt_w, gt_h, gt_flag):
    '''
...
def computeOKSAP(est_result, gt_result, img_path, img_w, img_h, gt_w, gt_h):
    ...
    est_lst = parse_pose_result(est_result, img_path, img_w, img_h, gt_w, gt_h, False)
    ...
    gt_lst = parse_pose_result(gt_result, img_path, img_w, img_h, gt_w, gt_h, True)
    ...
    #if img_w == 320:
    #    print ("est_lst, gt_lst111: ", est_lst)
    #    print ("est_lst, gt_lst222: ", gt_lst)
