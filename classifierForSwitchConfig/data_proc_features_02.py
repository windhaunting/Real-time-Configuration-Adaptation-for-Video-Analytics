...
from common_classifier import read_config_name_resolution_frm_rate
...
def getOnePersonAllKPHistorySpeed(data_pose_keypoint_dir, history_frame_num, max_frame_example_used):
    ...
    #config_id_dict, id_config_dict = read_config_name_resolution_frm_rate(data_pose_keypoint_dir, False)
...
def getGroundTruthY(max_frame_example_used, history_frame_num):
    ...
    this dataset Y
    '''
    data_pickle_dir = dataDir2 + 'output_006-cardio_condition-20mins/' + 'pickle_files_tuple_resoFR/'
...
def getDataExamples():
    ...
    out_frm_examles_pickle_dir = data_pose_keypoint_dir + "data_examples_files_resoFR_tuple/" 
