...
def xgbBoostTrainTest(data_classification_dir, X, y):
    ...
    y_train_used_pred = xgb_model.predict(X_train)
    y_test_used_pred = xgb_model.predict(X_test)
    ...
    print ("xgbBoostTrainTest y predicted config: ", y_test_used_pred)
    ...
    return xgb_model, train_acc_score, test_acc_score, train_video_frm_id_arr, test_video_frm_id_arr, y_test_used_pred, y_test
...
def combineMultipleVideoDataTrainTest():
    ...
    rf_model, train_acc_score, test_acc_score, train_video_frm_id_arr, test_video_frm_id_arr, y_pred, y_test = xgbBoostTrainTest(data_classification_dir, total_X, total_y)
