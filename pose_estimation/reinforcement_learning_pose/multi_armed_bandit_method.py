...
class MultiArmedConfig(object):
    ...
    def calculate_acccury(configs_selected, ground_truth_configs):
        pass
    ...
    def online_learning_RL(self):
        ...
        min_acc_thres = 0   # 0.95 # 0.9         # minimum accuracy threshold
        ...
        for i, video_dir in enumerate(video_dir_lst[0:1]): # [3:4]):    # [2:3]:   #[1:2]:  # [1:2]:  #[0:1]:        #[1:2]:
            ...
            #self.configuraiton__online_epoch_greedy(config_est_frm_arr, acc_frame_arr, spf_frame_arr, update_interval_time, processing_interval_time, dataDir3 + video_dir)
            
            #self.configuraiton__online_epoch_greedy_min_accury_threshold(config_est_frm_arr, acc_frame_arr, spf_frame_arr, update_interval_time, processing_interval_time, min_acc_thres, dataDir3 + video_dir)
            
            self.configs_online_epoch_greedy_min_accuracy_threshold_prediction(config_est_frm_arr, acc_frame_arr, spf_frame_arr, update_interval_time, processing_interval_time, min_acc_thres, dataDir3 + video_dir)
